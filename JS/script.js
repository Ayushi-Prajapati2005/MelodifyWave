...
async function getSongs(folder) {
    ...
    // Attach click events to play a song
...
async function displayAlbums() {
    ...
    // Click card to load playlist and play first song
...
async function main() {
    ...
    // Load default folder (first in JSON)
